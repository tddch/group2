...
public class MarkerDemo extends AppCompatActivity {
    ...
    public void Azz(Lat latLng) {
        LatLng latLng1 = latLng.getLatLng();
        city = latLng.getCity();
        Log.e("tag",latLng1+"ddddddddddddddd");


        LatLng latLngA = new LatLng(latLng1.latitude,latLng1.longitude);
