...
import com.example.liujian.utils.NodeUtils;
import com.example.liujian.utils.RouteLineAdapter;
import com.example.liujian.utils.SelectRouteDialog;

public class BaiduActivity extends AppCompatActivity  implements BaiduMap.OnMapClickListener,
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            ...
            android.app.AlertDialog.Builder builder = new AlertDialog.Builder(BaiduActivity.this);
            builder.setTitle("提示");
        ...
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BaiduActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        } else {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShowDialog) {
                    SelectRouteDialog selectRouteDialog = new SelectRouteDialog(BaiduActivity.this,
