package com.example.bddt.activity2;
...
import com.example.bddt.util.Cluster;
import com.example.bddt.util.ClusterItem;
import com.example.bddt.util.ClusterManager;
...
public class DotActivity extends AppCompatActivity implements BaiduMap.OnMapLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_dot);
        ...
        mClusterManager.setOnClusterClickListener(new ClusterManager.OnClusterClickListener<MyItem>() {
            ...
            public boolean onClusterClick(Cluster<MyItem> cluster) {
                Toast.makeText(DotActivity.this, "有" + cluster.getSize() + "个点", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
